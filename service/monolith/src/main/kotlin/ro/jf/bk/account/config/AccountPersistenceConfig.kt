...
private const val ACCOUNT_REPOSITORY_PACKAGE = "ro.jf.bk.account.persistence.repository"
private const val ACCOUNT_ENTITY_PACKAGE = "ro.jf.bk.account.persistence.entity"
...
class AccountPersistenceConfig(
    ...
    // TODO(Johann) use data source that handles connection pooling
    @Bean
